...
load('./result/tmpfile_imc_1229.mat', 'AllAnalysisInfo');
filename = ['./result/tmpfile_imc_', currentDate, '.mat'];
load(filename, 'AllAnalysisInfo');
tic

AllAnalysisInfo_common = cell(1,1); % モデル情報をすべて記録
tic
...
[illum, obj] = subfunc.IlluminationModelAnalysis_limited_cluster(AllAnalysisInfo, pm, cluster_member, obj_threshold);
...
cluster_string = strrep(num2str(cluster_member), ' ', '');
filename = ['./result/model_all_condition_limited_C',cluster_string,'_', currentDate, '.mat'];
